...
#define DEVICE_NAME			"it7258"
#define SCREEN_X_RESOLUTION		390
#define SCREEN_Y_RESOLUTION		390
...
#define IT_VTG_MIN_UV		1808000
#define IT_VTG_MAX_UV		1808000
#define IT_ACTIVE_LOAD_UA	15000
#define IT_I2C_VTG_MIN_UV	3008000
#define IT_I2C_VTG_MAX_UV	3008000
...
static irqreturn_t it7260_ts_threaded_handler(int irq, void *devid)
{
	...
	for (finger = 0; finger < ts_data->pdata->num_of_fingers; finger++) {
		...
		x = 390 - pt_data.fd[finger].xLo +
			(((u16)(pt_data.fd[finger].hi & 0x0F)) << 8);
		y = 390 - pt_data.fd[finger].yLo +
