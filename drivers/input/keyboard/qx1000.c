...
static const u16 qwerty_keys[AW9523_NR_KEYS] = {
	...
	KEY_2,		KEY_4,		KEY_TAB,	KEY_RIGHTALT/*GPIO - Right Fn as AltGr TODO: switch back to KEY_RESERVED */,
};
static const u16 qwerty_fn_keys[AW9523_NR_KEYS] = {
	/* 0..7 */
	KEY_LEFTMETA/*GPIO - F(x)tec*/,			KEY_H,				KEY_B,				KEY_7 | KF_SHIFT,
	...
	/* 24..31 */
	KEY_RIGHTALT,			KEY_A,				KEY_RIGHTBRACE | KF_SHIFT,	KEY_LEFTSHIFT/*GPIO*/,
	...
	/* 56..63 */
	KEY_BACK,			KEY_1 | KF_SHIFT,		KEY_LEFTALT/*GPIO*/,	KEY_RESERVED/*GPIO - Silent Fn*/,
	KEY_2 | KF_SHIFT,		KEY_4 | KF_SHIFT,		KEY_CYCLEWINDOWS,		KEY_RIGHTALT/*GPIO - Right Fn as AltGr TODO: switch back to KEY_RESERVED */,
};
...
static void gpio_keys_gpio_report_event(struct gpio_button_data *bdata)
{
 ...
 printk(KERN_INFO "aw9523b: gpio_keys_gpio_report_event: desc=%s code=%u state=%d\n",
	...
	// Defensive, we expect our button code to be within range of our keys array as defined in DTSI file
	if (button->code>=AW9523_NR_KEYS) {
